                                ...
                                <div class="tab-content p-3 text-muted">
                                    <div class="tab-pane active" id="home-1" role="tabpanel">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description_az" id="editor" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="profile-1" role="tabpanel">
                                        ...
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Ətraflı mətn</label>
                                            <div class="col-sm-10">
                                                <textarea name="description_en" id="editor1" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="messages-1" role="tabpanel">
                                        ...
                                        <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Ətraflı mətn</label>
                                            <div class="col-sm-10">
                                                <textarea name="description_ru" id="editor2" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>
